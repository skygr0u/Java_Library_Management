...
public class MemberHistoryLoanBookPage extends javax.swing.JFrame {
    ...
    public MemberHistoryLoanBookPage(int memberId) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/letter.png"))); // NOI18N
        jLabel22.setText("  Loan History");
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 10, 490, 130));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 230, 1190, 470));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MemberHistoryLoanBookPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
