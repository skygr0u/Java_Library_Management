...
public class DeleteFormAuthor extends javax.swing.JFrame {
    ...
    private void DeleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteBtnActionPerformed
        ...
        if (AuthorID.isEmpty()){
            JOptionPane.showMessageDialog(this, "Enter AuthorID ID");
        }
        else if (deleteSubscriber()== true) {
            JOptionPane.showMessageDialog(this, "AuthorID Deleted");
            dispose();
        }else{
            JOptionPane.showMessageDialog(this, "AuthorID Deletion Failed","Error", JOptionPane.ERROR_MESSAGE);
            dispose();
        }
